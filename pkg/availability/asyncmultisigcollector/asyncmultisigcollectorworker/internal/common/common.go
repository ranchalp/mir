...
type ModuleParams struct {
	...
	PrevBatchID   t.BatchID  // the batch IDs of the previous batch delivered by each node
	DeliveredCert *mscpbtypes.Cert
	Source        t.NodeID // nodeID that should propose in this module
	WorkerCount   int64
}
