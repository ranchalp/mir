...
type Message struct {
	...
	//	*Message_Cert
	//	*Message_RequestCertRange
	//	*Message_ProvideCertRange
...
func (x *Message) GetCert() *CertMessage {
	if x, ok := x.GetType().(*Message_Cert); ok {
		return x.Cert
	}
	return nil
}

func (x *Message) GetRequestCertRange() *RequestCertRangeMessage {
	if x, ok := x.GetType().(*Message_RequestCertRange); ok {
		return x.RequestCertRange
	}
	return nil
}

func (x *Message) GetProvideCertRange() *ProvideCertRangeMessage {
	if x, ok := x.GetType().(*Message_ProvideCertRange); ok {
		return x.ProvideCertRange
	}
	return nil
}
...
type Message_Cert struct {
	Cert *CertMessage `protobuf:"bytes,5,opt,name=cert,proto3,oneof"`
}

type Message_RequestCertRange struct {
	RequestCertRange *RequestCertRangeMessage `protobuf:"bytes,6,opt,name=request_cert_range,json=requestCertRange,proto3,oneof"`
}

type Message_ProvideCertRange struct {
	ProvideCertRange *ProvideCertRangeMessage `protobuf:"bytes,7,opt,name=provide_cert_range,json=provideCertRange,proto3,oneof"`
}
...
type RequestSigMessage struct {
	...
	PrevBatch string               `protobuf:"bytes,2,opt,name=prev_batch,json=prevBatch,proto3" json:"prev_batch,omitempty"`
...
func (x *RequestSigMessage) GetPrevBatch() string {
	if x != nil {
		return x.PrevBatch
	}
	return ""
...
type RequestCertRangeMessage struct {
	...
	BatchIdFrom []byte `protobuf:"bytes,1,opt,name=batch_id_from,json=batchIdFrom,proto3" json:"batch_id_from,omitempty"`
	BatchIdTo   []byte `protobuf:"bytes,2,opt,name=batch_id_to,json=batchIdTo,proto3" json:"batch_id_to,omitempty"`
}

func (x *RequestCertRangeMessage) Reset() {
	*x = RequestCertRangeMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *RequestCertRangeMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RequestCertRangeMessage) ProtoMessage() {}

func (x *RequestCertRangeMessage) ProtoReflect() protoreflect.Message {
	mi := &file_availabilitypb_mscpb_mscpb_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RequestCertRangeMessage.ProtoReflect.Descriptor instead.
func (*RequestCertRangeMessage) Descriptor() ([]byte, []int) {
	return file_availabilitypb_mscpb_mscpb_proto_rawDescGZIP(), []int{5}
}

func (x *RequestCertRangeMessage) GetBatchIdFrom() []byte {
	if x != nil {
		return x.BatchIdFrom
	}
	return nil
}

func (x *RequestCertRangeMessage) GetBatchIdTo() []byte {
	if x != nil {
		return x.BatchIdTo
	}
	return nil
...
func (x *ProvideCertRangeMessage) Reset() {
	*x = ProvideCertRangeMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProvideCertRangeMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProvideCertRangeMessage) ProtoMessage() {}

func (x *ProvideCertRangeMessage) ProtoReflect() protoreflect.Message {
	mi := &file_availabilitypb_mscpb_mscpb_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProvideCertRangeMessage.ProtoReflect.Descriptor instead.
func (*ProvideCertRangeMessage) Descriptor() ([]byte, []int) {
	return file_availabilitypb_mscpb_mscpb_proto_rawDescGZIP(), []int{6}
}

func (x *ProvideCertRangeMessage) GetCerts() []*Cert {
	if x != nil {
		return x.Certs
	}
	return nil
...
type CertMessage struct {
	...
	Msc *Cert `protobuf:"bytes,1,opt,name=msc,proto3" json:"msc,omitempty"`
}

func (x *CertMessage) Reset() {
	*x = CertMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_availabilitypb_mscpb_mscpb_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *CertMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CertMessage) ProtoMessage() {}

func (x *CertMessage) ProtoReflect() protoreflect.Message {
	mi := &file_availabilitypb_mscpb_mscpb_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CertMessage.ProtoReflect.Descriptor instead.
func (*CertMessage) Descriptor() ([]byte, []int) {
	return file_availabilitypb_mscpb_mscpb_proto_rawDescGZIP(), []int{8}
}

func (x *CertMessage) GetMsc() *Cert {
	if x != nil {
		return x.Msc
	}
	return nil
...
type InstanceParams struct {
	...
	PrevBatchId string               `protobuf:"bytes,4,opt,name=prev_batch_id,json=prevBatchId,proto3" json:"prev_batch_id,omitempty"`
}

func (x *InstanceParams) Reset() {
	*x = InstanceParams{}
	if protoimpl.UnsafeEnabled {
		mi := &file_availabilitypb_mscpb_mscpb_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InstanceParams) Descriptor() ([]byte, []int) {
	return file_availabilitypb_mscpb_mscpb_proto_rawDescGZIP(), []int{9}
}
...
func (x *InstanceParams) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
func (x *InstanceParams) GetWorkerCount() int64 {
	if x != nil {
...
func (x *InstanceParams) GetPrevBatchId() string {
	if x != nil {
...
var file_availabilitypb_mscpb_mscpb_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xba, 0x04, 0x0a, 0x07, 0x4d, 0x65, 0x73,
	...
	,
	...
	0x73, 0x12, 0x54, 0x0a, 0x0a, 0x70, 0x72, 0x65, 0x76, 0x5f, 0x62, 0x61, 0x74, 0x63, 0x68, 0x18,
	...
	0x79, 0x70, 0x65, 0x73, 0x2e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x49, 0x44, 0x52, 0x09, 0x70, 0x72,
	0x65, 0x76, 0x42, 0x61, 0x74, 0x63, 0x68, 0x12, 0x15, 0x0a, 0x06, 0x72, 0x65, 0x71, 0x5f, 0x69,
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x72, 0x65, 0x71, 0x49, 0x64, 0x3a, 0x04,
	0xd0, 0xe4, 0x1d, 0x01, 0x22, 0x47, 0x0a, 0x0a, 0x53, 0x69, 0x67, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	0x52, 0x05, 0x72, 0x65, 0x71, 0x49, 0x64, 0x3a, 0x04, 0xd0, 0xe4, 0x1d, 0x01, 0x22, 0x4d, 0x0a,
	0x13, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x62, 0x61, 0x74, 0x63, 0x68, 0x49, 0x64, 0x12,
	0x15, 0x0a, 0x06, 0x72, 0x65, 0x71, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x05, 0x72, 0x65, 0x71, 0x49, 0x64, 0x3a, 0x04, 0xd0, 0xe4, 0x1d, 0x01, 0x22, 0x58, 0x0a, 0x13,
	0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4d, 0x65, 0x73, 0x73,
	...
	,
	...
	0x74, 0x52, 0x05, 0x63, 0x65, 0x72, 0x74, 0x73, 0x3a, 0x04, 0xd0, 0xe4, 0x1d, 0x01, 0x22, 0x97,
	0x01, 0x0a, 0x04, 0x43, 0x65, 0x72, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x62, 0x61, 0x74, 0x63, 0x68,
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x62, 0x61, 0x74, 0x63, 0x68,
	0x49, 0x64, 0x12, 0x4e, 0x0a, 0x07, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20,
	...
	0x65, 0x73, 0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x49, 0x44, 0x52, 0x07, 0x73, 0x69, 0x67, 0x6e, 0x65,
	...
	0x65, 0x73, 0x3a, 0x04, 0x98, 0xa6, 0x1d, 0x01, 0x22, 0x41, 0x0a, 0x0b, 0x43, 0x65, 0x72, 0x74,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x2c, 0x0a, 0x03, 0x6d, 0x73, 0x63, 0x18, 0x01,
	...
	0x52, 0x03, 0x6d, 0x73, 0x63, 0x3a, 0x04, 0xd0, 0xe4, 0x1d, 0x01, 0x22, 0x98, 0x02, 0x0a, 0x0e,
	0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x34,
	...
	0x73, 0x68, 0x69, 0x70, 0x12, 0x4c, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x02,
	...
	0x70, 0x65, 0x73, 0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x49, 0x44, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72,
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x59, 0x0a, 0x0d, 0x70, 0x72, 0x65, 0x76, 0x5f, 0x62, 0x61,
	0x74, 0x63, 0x68, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x35, 0x82, 0xa6,
	...
	0x72, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x42, 0x61, 0x74, 0x63,
	0x68, 0x49, 0x44, 0x52, 0x0b, 0x70, 0x72, 0x65, 0x76, 0x42, 0x61, 0x74, 0x63, 0x68, 0x49, 0x64,
...
var file_availabilitypb_mscpb_mscpb_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_availabilitypb_mscpb_mscpb_proto_goTypes = []interface{}{
	...
	(*RequestCertRangeMessage)(nil), // 5: availabilitypb.mscpb.RequestCertRangeMessage
	(*ProvideCertRangeMessage)(nil), // 6: availabilitypb.mscpb.ProvideCertRangeMessage
	(*Cert)(nil),                    // 7: availabilitypb.mscpb.Cert
	(*CertMessage)(nil),             // 8: availabilitypb.mscpb.CertMessage
	(*InstanceParams)(nil),          // 9: availabilitypb.mscpb.InstanceParams
	(*requestpb.Request)(nil),       // 10: requestpb.Request
	(*commonpb.Membership)(nil),     // 11: commonpb.Membership
}
var file_availabilitypb_mscpb_mscpb_proto_depIdxs = []int32{
	...
	8,  // 4: availabilitypb.mscpb.Message.cert:type_name -> availabilitypb.mscpb.CertMessage
	5,  // 5: availabilitypb.mscpb.Message.request_cert_range:type_name -> availabilitypb.mscpb.RequestCertRangeMessage
	6,  // 6: availabilitypb.mscpb.Message.provide_cert_range:type_name -> availabilitypb.mscpb.ProvideCertRangeMessage
	10, // 7: availabilitypb.mscpb.RequestSigMessage.txs:type_name -> requestpb.Request
	10, // 8: availabilitypb.mscpb.ProvideBatchMessage.txs:type_name -> requestpb.Request
	7,  // 9: availabilitypb.mscpb.ProvideCertRangeMessage.certs:type_name -> availabilitypb.mscpb.Cert
	7,  // 10: availabilitypb.mscpb.CertMessage.msc:type_name -> availabilitypb.mscpb.Cert
	11, // 11: availabilitypb.mscpb.InstanceParams.membership:type_name -> commonpb.Membership
...
func file_availabilitypb_mscpb_mscpb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_availabilitypb_mscpb_mscpb_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RequestCertRangeMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_availabilitypb_mscpb_mscpb_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProvideCertRangeMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_availabilitypb_mscpb_mscpb_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CertMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_availabilitypb_mscpb_mscpb_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	file_availabilitypb_mscpb_mscpb_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*Message_Cert)(nil),
		(*Message_RequestCertRange)(nil),
		(*Message_ProvideCertRange)(nil),
	}
	type x struct{}
